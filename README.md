...
- To setup the action, add the following snippet after the step that publishes the new release and assets:
  ...
  - name: Update new version in krew-index
    uses: rajatjindal/krew-release-bot@v0.0.49
  ```
...
```bash
$ docker run -v /path/to/your/template-file.yaml:/tmp/template-file.yaml ghcr.io/rajatjindal/krew-release-bot:v0.0.49 \
